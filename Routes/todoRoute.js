 ...
 *     tags:
 *       - Todo
 *     summary: Get all todo list from database (need auth)
 *     responses:
 *       '200':
 *         description: Success
 *       '403':
 ...
 *     tags:
 *       - Todo
 *     summary: Add a new todo list (need auth)
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     tags:
 *       - Todo
 *     summary: Update todo list (need auth)
 *     parameters:
 *       - name: id
 *         in: path
 *         required: true
 ...
 *     tags:
 *       - Todo
 *     summary: Delete a todo (need auth)
 *     parameters:
 *       - name: id
 *         in: path
 *         required: true
